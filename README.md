...
<p style="font-size: 15px; color: #333333;">
    This repository demonstrates how to implement the content based filtering algorithm from scratch using NumPy and a neural network from TensorFlow. The objective of this project was to gain a deeper understanding of how the algorithm works internally by manually coding each step of the algorithm rather than relying on high-level libraries.
</p>
...
<p style="font-size: 15px; color: #333333;">
    The code includes implementation of two neural networks for generating the optimum vectors for the user and the movie, and a distance matrix to compute the similarity between a given movie and all other movies. The algorithm was tested on a movie rating recommendation exercise.
</p>
